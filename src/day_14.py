        ...
        if line[0:2] == 'ma':
            ...
            for i, char in enumerate(line):
                if char == "]":
                    ...
                    equal_index = i
            # mem[line[4:closed_index]] = apply_mask_2(int(line[equal_index + 2:]), mask)
                indexes_to_write = apply_mask_2(int(mem[line[4:closed_index]]), mask)
...
def apply_mask_2(value: int, mask: str):
    result = []
